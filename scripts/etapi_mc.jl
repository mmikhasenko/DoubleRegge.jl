...
p1 = let
    ...
    scatterhist!(
        sqrt.(pseudodata_with_mw.s1),
        weights = pseudodata_with_mw.m7,
        norm = true,
        lab = "data",
        c = 1,
    )
...
p2 = let bins=range(3, 15, length = 50)
    ...
    scatterhist!(
        sqrt.(pseudodata_with_mw.sηp),
        weights = pseudodata_with_mw.m7 ./ pseudodata_with_mw.invwt,
        norm = true,
        lab = "data backward",
        bins = bins,
    )
    ...
    stephist!(
        sqrt.(pseudodata_with_mw.sηp),
        weights = pseudodata_with_mw.m3 ./ pseudodata_with_mw.invwt,
        norm = true,
        lab = l3,
        bins = bins,
    )
    stephist!(
        sqrt.(pseudodata_with_mw.sηp),
        weights = pseudodata_with_mw.m4 ./ pseudodata_with_mw.invwt,
        norm = true,
        lab = l4,
        bins = bins,
    )
    stephist!(
        sqrt.(pseudodata_with_mw.sηp),
        weights = pseudodata_with_mw.m5 ./ pseudodata_with_mw.invwt,
        norm = true,
        lab = l3*"+shift",
        bins = bins,
    )
